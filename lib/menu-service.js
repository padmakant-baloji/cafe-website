...
function loadQuickKartMenuJson() {
...
function clearQuickKartMenuCache() {
...
async function getAggregatedCustomerMenu() {
    ...
    const quickkartMenu = loadQuickKartMenuJson();
...
async function saveAdminMenuForVenue(actingVenue, targetVenueId, body) {
    ...
    if (isMainVenue(venue)) {
        throw Object.assign(new Error('QuickKart Cafe menu is managed in menu.json.'), { statusCode: 400 });
    }
...
module.exports = {
    ...
    loadQuickKartMenuJson,
    clearQuickKartMenuCache,
