...
function loadBaloji CafeMenuJson() {
...
function clearBaloji CafeMenuCache() {
...
async function getAggregatedCustomerMenu() {
    ...
    const quickkartMenu = loadBaloji CafeMenuJson();
...
module.exports = {
    ...
    loadBaloji CafeMenuJson,
    clearBaloji CafeMenuCache,
