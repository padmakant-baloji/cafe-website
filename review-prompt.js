    ...
    modal.innerHTML = `
        <div class="checkout-modal-content google-review-modal-content" tabindex="-1">
            <div class="google-review-modal-inner">
                ...
                <p class="google-review-lead" id="googleReviewLead">We’d love a quick Google review — it helps more neighbors find FoodKart’s Cafe.</p>
...
function showModal(payload) {
    ...
    if (lead) {
        ...
        lead.textContent = id
            ? `Order #${id} is complete. We’d love a quick Google review — it helps more neighbors find FoodKart’s Cafe.`
            : 'We’d love a quick Google review — it helps more neighbors find FoodKart’s Cafe.';
    }
